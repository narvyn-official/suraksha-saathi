...
**Next software priority:** run a bounded large-font and screen-reader accessibility audit of equipment inspection, component practice and delayed review in English/Hindi. Fix reproducible clipping or unreachable controls, provide equivalent non-camera actions, and record actual checks. Keep visual presence and physical-device validation separate; do this before expanding camera practice to more models.
