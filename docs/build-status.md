...
This document describes the implemented v0.3.1 pilot (curriculum 0.3.0). Earlier architecture documents describe the target system; they are not claims that every feature is shipped.
