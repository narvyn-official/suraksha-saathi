...
This document describes the implemented v0.4.0 pilot (curriculum 0.4.0). Earlier architecture documents describe the target system; they are not claims that every feature is shipped.
