...
The demo MP4 is a short emulator test run. It demonstrates app screens and an assessment; it does not demonstrate real camera tracking or a field trial. The test records in the local dashboard are explicitly named “Demo learner · test record”.
